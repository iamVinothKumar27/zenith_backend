...
### Render / Production (Mailgun)
Set these in Render environment variables:
- MAILGUN_API_KEY
- MAILGUN_DOMAIN (e.g., mg.zenithlearning.site)
- MAILGUN_BASE_URL (default: https://api.mailgun.net/v3)
- MAILGUN_FROM_DEFAULT (e.g., no-reply@zenithlearning.site)
- MAILGUN_FROM_CONTACT (e.g., contact@zenithlearning.site)

Optional:
- EMAIL_PROVIDER=smtp|mailgun|sendgrid (override auto-detect)
- MAILGUN_ALLOW_SPOOF_FROM=true (not recommended; may fail DMARC)
